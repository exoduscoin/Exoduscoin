...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "ExodusCoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"cr.net","213.252.244.121"},
    {"cr.net","213.252.245.239"},
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. ExodusCoin is probably already running."), addrBind.ToString().c_str());
        else
